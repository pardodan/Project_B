...
public:
    ...
    void print_syndrom(RS_WORD* temp,int nsym);//Raz 21.5
    ...
    bool decode_v2(RS_WORD* wholeOut, RS_WORD* out, RS_WORD* data,RS_WORD* error_data, int k, int nsym, vector<unsigned int>* erasePos, bool debug);
};

//function to run reed solomon
